...
audio.src = "./audios/beep.mp3";
let isFirstLoad = true;
const audio_timer = new Audio();
audio_timer.src = "./audios/seconds.mp3";

if (darkTheme)
  $id(".counter-background").css({ background: "rgb(25, 18, 18)" });
...
const updateTimerDisplay = () => {
  audio_timer.play();
  const minutesDisplay = Math.floor(currentTime / 60)
    .toString()
    .padStart(2, "0");
...
const startPomoCounter = () => {
  ...
  $id("timer-control").innerHTML = paused
